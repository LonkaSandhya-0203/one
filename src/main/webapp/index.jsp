...
<head>
    ...
    <title>NexusShop — Modern E‑Commerrce</title>

    <!-- Fonts & Icons -->
    <link href="https://fonts.g00gleapis.com/css2?family=Inter:wght@400;500;600&family=Poppins:wght@600;700&display=swap" rel="stylesheet">
...
<body>
    ...
    <main>
        ...
        <section class="hero" role="img" aria-label="Hero banner">
            <div class="container">
                <h1>Winter and summer Collections tooo — Premium Picks</h1>
